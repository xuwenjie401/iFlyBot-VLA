...
from utils.flow_matching.path import MixtureDiscreteProbPath

from utils.flow_matching.solver.solver import Solver
from utils.flow_matching.utils import categorical, ModelWrapper
    ...
    def sample(
        ...
        **model_extras,
        ...
        .. code-block:: python
            ...
            import torch
            from utils.flow_matching.utils import ModelWrapper
            from utils.flow_matching.solver import MixtureDiscreteEulerSolver
