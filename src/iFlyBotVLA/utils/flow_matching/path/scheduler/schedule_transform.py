...
from utils.flow_matching.path.scheduler.scheduler import Scheduler
...
class ScheduleTransformedModel(ModelWrapper):
    ...
    .. code-block:: python
        ...
        import torch
        from utils.flow_matching.path.scheduler import CondOTScheduler, CosineScheduler, ScheduleTransformedModel
        from utils.flow_matching.solver import ODESolver
