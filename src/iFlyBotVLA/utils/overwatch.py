...
DETAILED_FORMATTER = "%(asctime)s [%(levelname)s] %(name)s:%(lineno)d - %(message)s"
...
#     "disable_existing_loggers": True,
#     "formatters": {
#         "rich": {"format": RICH_FORMATTER, "datefmt": DATEFMT},
#         "file": {"format": DETAILED_FORMATTER, "datefmt": DATEFMT},
#     },
#     "handlers": {
#         "console": {
#             "class": "rich.logging.RichHandler",
